...
class Businesses extends Model {
  ...
  const Businesses._internal({required this.id, type, location, about, cac, createdAt, updatedAt}): _type = type, _location = location, _about = about, _cac = cac, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Businesses({String? id, String? type, String? location, String? about, String? cac}) {
  ...
  Businesses copyWith({String? id, String? type, String? location, String? about, String? cac}) {
    return Businesses._internal(
      id: id ?? this.id,
      type: type ?? this.type,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'type': _type, 'location': _location, 'about': _about, 'cac': _cac, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
